...
exports.PlaceSubmissionsService = void 0;
const supabase_1 = require("../config/supabase");
const placesService_1 = require("./placesService");
class PlaceSubmissionsService {
    placesService;
    constructor() {
        this.placesService = new placesService_1.PlacesService();
    }
    ...
    async updateSubmissionStatus(id, status, adminNotes) {
        try {
            ...
            const { data: updatedSubmission, error: updateError } = await supabase_1.supabase
                .from('place_submissions')
                .update({
                status,
...
exports.PlaceSubmissionsService = PlaceSubmissionsService;
//# sourceMappingURL=placeSubmissionsService.js.map